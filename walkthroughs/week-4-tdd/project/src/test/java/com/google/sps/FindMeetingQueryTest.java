...
public final class FindMeetingQueryTest {
  ...
  private static final int TIME_START_OF_DAY = TimeRange.START_OF_DAY;
  ...
  private static final int TIME_END_OF_DAY = TimeRange.END_OF_DAY;
...
@Test
  ...
  @Test
  public void earlyDayOptionalAttendee() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
...
Collection<Event> events = Arrays.asList(
    ...
    new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
        Arrays.asList(PERSON_B)),
    new Event("Event 3", TimeRange.fromStartEnd(TIME_START_OF_DAY, TIME_END_OF_DAY, true),
        Arrays.asList(PERSON_C)));
...
@Test
public void noGapsOptionAttendees() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TIME_START_OF_DAY, TIME_0830AM, false), Arrays.asList(PERSON_A, PERSON_B)),
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0830AM, TIME_END_OF_DAY, false), Arrays.asList(PERSON_A, PERSON_B)));
